				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">	
							 ...
							 <ul>
								<li><a href="controller?action=formFornecedor&tarefa=cadastrar">Cadastrar</a></li>
								<li><a href="controller?action=formFornecedor&tarefa=atualizar">Atualizar</a></li>
								<li><a href="controller?action=formFornecedor&tarefa=excluir">Excluir</a></li>
							</ul>
