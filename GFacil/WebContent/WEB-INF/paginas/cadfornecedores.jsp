...
<body class="no-skin">
			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="page-header">
						<h1><strong>Fornecedores</strong>
							<small>
								<i class="ace-icon fa fa-angle-double-right"></i> <strong>gestão de fornecedores</strong>
							</small>							
						</h1>
					</div>
					...
					<div class="row">
						<div class="col-xs-12">							
							...
							<c:if test="${usuarioLogado.perfil != 'COMPRADOR'}">
							...
							<div class="tableTools-container">
								<div class="btn-group btn-over-lap">
									...
									<a href="#" class="btn btn-app btn-success btn-xs" role="cadastrar">
										<i class="ace-icon fa fa-plus bigger-130">&nbsp;<i class="ace-icon fa fa-truck bigger-130"></i></i>Novo
									</a>
								</div>
							</div>
							<div class="breadcrumbs">
								...
								<div class="nav-search" id="nav-search">
									<form class="form-search" id="formPesquisarFornecedor" action="controller?action=pesquisarFornecedor" method="POST">
							...
							<c:choose>
								...
								<!-- CASO HAJA FORNECEDOR -->						
										
									<!-- RESULTADO DO NÚMEROS DE USUÁRIOS -->
									<div class="table-header">
										<strong>Resultado: " ${fornecedores.size()} fornecedor(es) cadastrado(s) "</strong>
									</div>										
									...
									<div>
										...
										<table id="simple-table" class="table table-striped table-bordered table-hover">
											...
											<tbody>
												...
												<!-- MONTA AS LINHAS CONFORME A EXISTÊNCIA DE FORNECEDORES -->
												<c:forEach var="fornecedor" items="${fornecedores}">
													<tr>														
														<!-- COLUNA ESCONDIDA DE CÓDIGO DOS REGISTROS -->
														<td class="hidden">${fornecedor.codigo}</td>
														<td class="hidden">${fornecedor.tipo}</td>
							...
							<div id="modal-form-fornecedor" class="modal fade" tabindex="-1" rel="modalcadastrar">
	    										...
	    										<div>    											
													...
													<div class="radio">
														<label for="tipoFornecedor2" class="lblRadio">
															<input type="radio" name="tipoFornecedor" id="tipoFornecedor2" value="CATADOR" />Catador de Material
														</label>
													</div>
												</div>
											</div>										
							...
							<div id="modal-form-fornecedor" class="modal fade" tabindex="-1" rel="modalexcluir">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal">&times;</button>
										...
										<div class="modal-body">										
											...
											<div class="form-group">
	    										...
	    										<div>    											
													<div class="radio">										
														<label for="tipoFornecedor1" class="lblRadio">
															<input type="radio" name="tipoFornecedor" id="tipoFornecedor1" value="EMPRESA" />Empresa
														</label>
													</div>
													<div class="radio">
														<label for="tipoFornecedor2" class="lblRadio">
							...
							<div id="modal-form-fornecedor" class="modal fade" tabindex="-1" rel="modalatualizar">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal">&times;</button>
							...
							<div id="modal-form-fornecedor" class="modal fade" tabindex="-1" rel="modalcep">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal">&times;</button>
    ...
    <!-- EDITAR EXCLUIR -->
    <script src="resources/js/manipulatabelafornecedor.js"></script>
